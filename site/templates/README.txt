...
web applications or anything else that you might do with Smarty. 
...
directly refer to it in your Smarty code.  For instance, if you wanted to echo the page's $title field
